...
* The marketplace serves **96,096 unique customers**.
...
* The overall late delivery rate was **8.11%** of orders with a known delivery outcome.
...
![Sales & Revenue Dashboard](dashboard/image/dashboard_sales_revenue.png)

### 2. Customers & Payments

![Customers & Payments Dashboard](dashboard/image/dashboard_customers_payments.png)

### 3. Products & Categories

![Products & Categories Dashboard](dashboard/image/dashboard_products_categories.png)

### 4. Delivery Performance

![Delivery Performance Dashboard](dashboard/image/dashboard_delivery_performance.png)
...
> **Note:** the `data/` folder is excluded from version control via `.gitignore` due to file size. To reproduce this project, download the [Olist Brazilian E-Commerce dataset from Kaggle](https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce), place the raw CSVs in `data/RAW/`, and run `notebooks/02_data_cleaning.ipynb` to generate the cleaned files in `data/processed/`.
